...
// controls must be loaded after elements
...
module.exports = function(Chart) {
	...
	Chart.controls.bar = Chart.DatasetController.extend({
	...
	Chart.controls.horizontalBar = Chart.controls.bar.extend({
		/**
		 * @private
		 */
		getValueScaleId: function() {
...
module.exports = function(Chart) {
	...
	Chart.controls.bubble = Chart.DatasetController.extend({
		/**
		 * @protected
		 */
...
module.exports = function(Chart) {
	...
	Chart.controls.doughnut = Chart.controls.pie = Chart.DatasetController.extend({
...
module.exports = function(Chart) {
	...
	Chart.controls.line = Chart.DatasetController.extend({
...
module.exports = function(Chart) {
	...
	Chart.controls.polarArea = Chart.DatasetController.extend({
...
module.exports = function(Chart) {
	...
	Chart.controls.radar = Chart.DatasetController.extend({
...
module.exports = function(Chart) {
	...
	// Scatter charts use line controls
	Chart.controls.scatter = Chart.controls.line;
...
module.exports = function(Chart) {
	...
	// controls available for dataset visualization eg. bar, line, slice, etc.
	Chart.controls = {};
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		initialize: function() {
			...
			// Make sure scales have IDs and are built before we build any controls.
		...
		buildOrUpdatecontrols: function() {
			var me = this;
			var types = [];
			var newcontrols = [];
			...
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
				...
				if (meta.controller) {
					...
					var ControllerClass = Chart.controls[meta.type];
					if (ControllerClass === undefined) {
						throw new Error('"' + meta.type + '" is not a chart type.');
					}

					meta.controller = new ControllerClass(me, datasetIndex);
					newcontrols.push(meta.controller);
				}
			}, me);
		...
		*/
		...
		update: function(config) {
			...
			// Make sure dataset controls are updated and new controls are reset
			var newcontrols = me.buildOrUpdatecontrols();

			// Make sure all dataset controls have correct meta data counts
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
			...
			// Can only reset the new controls after the scales have been updated
			if (me.options.animation && me.options.animation.duration) {
				helpers.each(newcontrols, function(controller) {
					controller.reset();
				});
			}
		...
		destroy: function() {
			...
			// dataset controls need to cleanup associated data
...
module.exports = function(Chart) {
	...
	// Base class for all dataset controls (line, bar, etc)
...
function computeBoundary(source) {
	...
	// controls might still use it (e.g. the Smith chart).
