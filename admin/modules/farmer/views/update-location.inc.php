...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" method="post" onsubmit="return check();" action="index.php?app=farmer&action=edit-location" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-offset-9 col-lg-3" align="right">
                    <a href="?app=farmer&action=update&code=<?php echo $location['farmer_code']; ?>" class="btn btn-default">Back</a>
