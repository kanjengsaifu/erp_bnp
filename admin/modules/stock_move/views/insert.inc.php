            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="form-group">
                        ...
                        <input id="stock_move_date" name="stock_move_date"  class="form-control calendar" value="<?php echo date('d').'-'.date('m').'-'.date('Y');?>" readonly/>
                    ...
                    <div class="form-group">
                        ...
                        <select id="employee_code" name="employee_code" class="form-control select" data-live-search="true">
                            ...
                            ?>
                            <option value="<?php echo $users[$i]['user_code'] ?>"><?php echo $users[$i]['name'] ?> (<?php echo $users[$i]['user_position_name'] ?>)</option>
                            <?
                            }
                            ?>
                        </select>
     ...
     function add_row(id){
        ...
        var options = {
            url: function(keyword) {
                return "modules/stock_move/controllers/getProductByKeyword.php?keyword="+keyword;
            },
