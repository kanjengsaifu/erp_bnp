<script>
    ...
    function get_supplier_detail(){
        ...
        $.post( "controllers/getSupplierByCode.php", { 'supplier_code': supplier_code}, function( data ) {
            ...
            // document.getElementById('purchase_order_credit_term').value = data.credit_
    ...
    function add_row_new(id){
        ...
        $(id).closest('table').children('tbody').append(
                '<tr class="odd gradeX">'+
                    ...
                    '<td >'+
                        '<input type="text" class="form-control" style="text-align: right;" autocomplete="off" name="invoice_supplier_list_price[]" onchange="update_sum(this);" value="0"/>'+  
                    '</td>'+
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=invoice_supplier&purchase_order_code=<?PHP echo $_GET['purchase_order_code'];?>&action=add" >
                            ...
                            <div class="row"> 
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_supplier_date_recieve" name="invoice_supplier_date_recieve" value="<?PHP echo $first_date;?>"  class="form-control calendar" onchange="" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_supplier_date" name="invoice_supplier_date"  class="form-control calendar" readonly onchange="update_invoice_supplier_due(this)"/>
                                        <p class="help-block">31/01/2018</p>
                                    </div>
                                </div> 
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="invoice_supplier_code_receive" name="invoice_supplier_code_receive" class="form-control" >
