<script>
    ...
    function show_purchase_order(id){
        ...
        var val_id = document.getElementsByName('purchase_order_list_id[]');
        ...
        for(var i = 0 ; i < val_id.length ; i++){
            purchase_order_list_id.push(val_id[i].value);
        }
        ...
        for(var i = 0 ; i < val_qty.length ; i++){
            if(val_qty[i].value ==0){
                ...
                console.log("purchase_order_list_qty:",purchase_order_list_qty[i])
            } 
        }
        ...
        if(supplier_id != ""){
            ...
            { 
                ...
                'purchase_order_list_qty': JSON.stringify(purchase_order_list_qty),
             }, function( data ) {
                ...
                if(data.length > 0){
                    ...
                    for(var i = 0; i < data.length ; i++){
                        ...
                        content += '<tr class="odd gradeX">'+
                                        '<td>'+
                                            '<input onchange="//show_receive(this);" onclick="add_row_by_click(this,'+i+')" type="checkbox" name="p_id" value="'+data[i].product_id+'" />'+     
                                        '</td>'+
                                        '<td>'+
                                            data[i].product_code+
                                        '</td>'+
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Purchase Order Management <b style="color:red;">[<?PHP echo $type;?>]</b> <?php echo $_SESSION['supplier_domestic']?></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=purchase_order&supplier_domestic=<?php echo $_SESSION['supplier_domestic'];?>&action=add&type=<?PHP echo $type; ?>" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="purchase_order_category" name="purchase_order_category" onchange="get_supplier_detail()" class="form-control" >
                                            ...
                                            <option <?php if(isset($_GET['customer_purchase_order_id'])){ ?> selected <?php }?>  value="Online">Online</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="purchase_order_code_online" name="purchase_order_code_online" class="form-control"  >
                                        <input id="purchase_check" type="hidden" value="" />
                                        <p class="help-block">Example : PO1801001.</p>
                                    </div>       
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Example : FOB shipping point, C.I.F, C&F </p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                        ...
                        <tbody  class="sorted_table">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    ...
                                    <?php if(isset($_GET['customer_purchase_order_id'])){ ?> 
                                        <span>List Code.</span>
