...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" method="post" onsubmit="return check();" action="index.php?app=agent&action=add-location" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
            ...
            <input id="agent_code" name="agent_code" value="<?php echo $agent_code; ?>" type="hidden">

            <div class="row">
                <div class="col-lg-offset-9 col-lg-3" align="right">
                    <a href="?app=agent&action=update&code=<?php echo $agent_code; ?>" class="btn btn-default">Back</a>
