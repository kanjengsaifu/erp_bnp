                ...
                $(id).closest('table').children('tbody').append(
                    '<tr class="odd gradeX">'+
                        ...
                        '<td>'+
                            ...
                            '<input class="example-ajax-post form-control" name="product_code[]" readonly value="'+data_buffer[i].product_code+'" onchange="show_data(this);" placeholder="Product Code" />'+ 
                        '</td>'+
                        '<td>'+
                        ...
                        '<td>'+
                            '<input type="text" class="form-control text-right" name="customer_purchase_order_list_price[]" autocomplete="off" value="'+price+'"  onchange="update_sum(this);" />'+
                        ...
                        '</td>'+
                        '<td><input type="text" class="form-control text-right" name="customer_purchase_order_list_price_sum[]" autocomplete="off" value="0.00" onchange="update_sum(this);" /></td>'+
                        '<td></td>'+
                        '<td>'+
    ...
    function add_row_new(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '</td>'+
                '<td>'+
                    '<input type="text" class="form-control text-right" name="customer_purchase_order_list_price_sum[]" autocomplete="off" onchange="update_sum(this);" />'+               
                '</td>'+
                    ...
                    <table name="tb_list" width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><input type="text" class="form-control text-center" onchange="update_sum(this);" name="customer_purchase_order_list_qty[]" autocomplete="off" value="<?php echo number_format($customer_purchase_order_lists[$i]['customer_purchase_order_list_qty'],2); ?>" /></td>
                                <td>
                                    <input type="text" class="form-control text-right" onchange="update_sum(this);" name="customer_purchase_order_list_price[]" autocomplete="off" value="<?php echo number_format($customer_purchase_order_lists[$i]['customer_purchase_order_list_price'],2); ?>" />
                                ...
                                <td><input type="text" class="form-control text-right" onchange="update_sum(this);" name="customer_purchase_order_list_price_sum[]" autocomplete="off" value="<?php echo number_format($customer_purchase_order_lists[$i]['customer_purchase_order_list_price_sum'],2); ?>" /></td>
                                <td>
                                <?PHP /*?>
...
<script>
    ...
    $(".example-ajax-post").easyAutocomplete(options);
    $(function() {
        $('input[name="product_code[]"]' ).change();
    });
