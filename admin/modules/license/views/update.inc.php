    ...
    function checkAll(id,name,class_name){
        ...
        if (checkbox[0].checked == true ){
            ...
            if(class_name=="view"){
                ...
                $(id).closest('table').children('tbody').children('tr').children('td').children('input[class="approve"]').prop('checked', false);
                        ...
                        ?>
                            <tr>  
                                ...
                                <td class="text-center"> 
                                    <input class="view" style="align:center;width: 20px;height: 20px;" type="checkbox" value="1" id="permission_view_<?PHP echo $menus[$i]['menu_code'];?>" name="permission_view_<?PHP echo $menus[$i]['menu_code'];?>" <?PHP if($license_permission['permission_view']){ echo 'checked';}?> onclick="oncheck('<?PHP echo $menus[$i]['menu_code'];?>','view');"> 
                                </td> 
                                <td class="text-center"> 
                                    <input class="add" style="align:center;width: 20px;height: 20px;" type="checkbox" value="1" id="permission_add_<?PHP echo $menus[$i]['menu_code'];?>" name="permission_add_<?PHP echo $menus[$i]['menu_code'];?>" <?PHP if($license_permission['permission_add']){ echo 'checked';}?>  onclick="oncheck('<?PHP echo $menus[$i]['menu_code'];?>','add');">  
                                </td> 
                                <td class="text-center"> 
                                    <input class="edit" style="align:center;width: 20px;height: 20px;" type="checkbox" value="1" id="permission_edit_<?PHP echo $menus[$i]['menu_code'];?>" name="permission_edit_<?PHP echo $menus[$i]['menu_code'];?>" <?PHP if($license_permission['permission_edit']){ echo 'checked';}?> onclick="oncheck('<?PHP echo $menus[$i]['menu_code'];?>','edit');">  
                                </td> 
                                <td class="text-center"> 
                                ...
                                <td class="text-center"> 
                                    <input class="cancel" style="align:center;width: 20px;height: 20px;" type="checkbox" value="1" id="permission_cancel_<?PHP echo $menus[$i]['menu_code'];?>" name="permission_cancel_<?PHP echo $menus[$i]['menu_code'];?>" <?PHP if($license_permission['permission_cancel']){ echo 'checked';}?> onclick="oncheck('<?PHP echo $menus[$i]['menu_code'];?>','cancel');">  
                                </td>
                                <td class="text-center"> 
                                    <input class="delete" style="align:center;width: 20px;height: 20px;" type="checkbox" value="1" id="permission_delete_<?PHP echo $menus[$i]['menu_code'];?>" name="permission_delete_<?PHP echo $menus[$i]['menu_code'];?>" <?PHP if($license_permission['permission_delete']){ echo 'checked';}?> onclick="oncheck('<?PHP echo $menus[$i]['menu_code'];?>','delete');">  
                                </td>
                            </tr>
