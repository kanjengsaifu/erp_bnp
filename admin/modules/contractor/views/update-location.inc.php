...
<div class="panel panel-default">
    <div class="panel-heading">
        เเก้ไขพิกัด / Edit Location
    </div>
    <div class="panel-body">
        <form role="form" method="post" onsubmit="return check();" action="index.php?app=contractor&action=edit-location" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <div class="row" style="padding:16px 0px;">	
                                <div class="col-md-6">
                                    <label>ลองติจูด / Longitude <font color="#F00"><b>*</b></font></label>
                                    <div class="form-group">
                                        <input required class="gllpLongitude form-control" id="location_long" name="location_long" value="<?php echo $location['location_long']; ?>" type="text">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>ละติจูด / Latitude <font color="#F00"><b>*</b></font></label>
                                    <div class="form-group">
                                        <input required class="gllpLatitude form-control" id="location_lat" name="location_lat" value="<?php echo $location['location_lat']; ?>" type="text">
                                    </div>
                                </div>
                            </div>
            ...
            <input id="location_code" name="location_code" value="<?php echo $location['location_code']; ?>" type="hidden">

            <div class="row">
                <div class="col-lg-offset-9 col-lg-3" align="right">
                    <a href="?app=contractor&action=update&code=<?php echo $location['contractor_code']; ?>" class="btn btn-default">Back</a>
