...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=contractor&action=add" >
            <div class="row"> 
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_name" name="contractor_name" class="form-control">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_lastname" name="contractor_lastname" class="form-control">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_email" name="contractor_email" type="email" class="form-control">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_mobile" name="contractor_mobile" type="text" class="form-control">
                        <p class="help-block">Example : 0610243003.</p>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <label>ยูสเซอร์ / Contractorname <font color="#F00"><b>*</b></font></label>
                        <input id="contractor_username" name="contractor_username" class="form-control">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_password" name="contractor_password" type="password" class="form-control">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input id="contractor_zipcode" name="contractor_zipcode" type="text" readonly class="form-control">
