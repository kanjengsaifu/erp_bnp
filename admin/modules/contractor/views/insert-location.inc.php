...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" method="post" onsubmit="return check();" action="index.php?app=contractor&action=add-location" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
            ...
            <input id="contractor_code" name="contractor_code" value="<?php echo $contractor_code; ?>" type="hidden">

            <div class="row">
                <div class="col-lg-offset-9 col-lg-3" align="right">
                    <a href="?app=contractor&action=update&code=<?php echo $contractor_code; ?>" class="btn btn-default">Back</a>
