...
$supplier = $invoice_supplier_model->generateInvoiceSupplierListBySupplierCode($_POST['supplier_code'],$purchase_order_list_code ,$_POST['search'],$_POST['purchase_order_code']);
//  echo '<pre>';
//  print_r($supplier);
//  echo '</pre>';
