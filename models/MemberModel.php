...
class MemberModel extends BaseModel{
    ...
    function getMemberBy($songserm_code,$member_type=""){
        $str_member_type ="";
        if($member_type!=""){
        ...
        $sql = " SELECT * 
        FROM  
        ((SELECT tb_contractor.contractor_code AS code,  CONCAT(contractor_prefix,' ',contractor_name,' ',contractor_lastname) as name , CONCAT('contractor') AS member_type ,profile_image 
        FROM tb_contractor  
        ...
        union 
        (SELECT tb_fund_agent.fund_agent_code AS code,  CONCAT(fund_agent_prefix,' ',fund_agent_name,' ',fund_agent_lastname) as name , CONCAT('fund_agent') AS member_type ,profile_image 
        FROM tb_fund_agent  
        ...
        union 
        (SELECT tb_agent.agent_code AS code,  CONCAT(agent_prefix,' ',agent_name,' ',agent_lastname) as name , CONCAT('agent') AS member_type  ,profile_image 
        FROM tb_agent  
        ...
        union 
        (SELECT tb_farmer.farmer_code AS code,  CONCAT(farmer_prefix,' ',farmer_name,' ',farmer_lastname) as name , CONCAT('farmer') AS member_type  ,profile_image 
        FROM tb_farmer  
